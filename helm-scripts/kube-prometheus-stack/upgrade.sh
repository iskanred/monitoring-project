...
# == Starting ==
echo "Helm release '$KUBE_PROMETHEUS_RELEASE_NAME' inside the namespace '$MONITORING_NAMESPACE_NAME' is started upgrading..."

# == Command ==
# helm upgrade [RELEASE] [CHART] flags

HELM_COMMAND="
helm upgrade $KUBE_PROMETHEUS_RELEASE_NAME ./helm-charts/kube-prometheus-stack \
